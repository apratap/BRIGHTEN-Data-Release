...
REPORTDIRECTORY <- "../Reports/2_Preparing_and_Staging_Data/"
...
getwd()
MatchedRecords <- read.csv("../Reports/1_Description_of_Initially_Available_Data/LocalMatchedRecords.csv", stringsAsFactors = FALSE)

FileInformation <- read.csv("../Reports/1_Description_of_Initially_Available_Data/LocalFileInformation.csv", stringsAsFactors = FALSE)
