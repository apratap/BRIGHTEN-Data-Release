...
FileInformation$brightenidCI <- paste("95% CI ",
                                      round(FileInformation$brightenidMeanObs 
                                            - (FileInformation$brightenidSD * 1.96)), 
                                      " to ", 
                                      round(FileInformation$brightenidMeanObs 
                                            + (FileInformation$brightenidSD * 1.96)))
FileInformation$userIDCI <- paste("95% CI ",
                                  round(FileInformation$userIDMeanObs 
                                        - (FileInformation$userIDSD * 1.96)), 
                                  " to ", 
                                  round(FileInformation$userIDMeanObs 
                                        + (FileInformation$userIDSD * 1.96)))
...
FileInformationPrivatized <- FileInformation[,c("volume","synID","fileName","brightenid","userID","N","userIDMeanObs","userIDCI","brightenidMeanObs","brightenidCI")]
...
toShow <- data.frame("Variable" = names(FileInformationPrivatized),
                     ...
                     "Description" = c("Study volume indicator",
                                       ...
                                       "95% confidence interval of mean on Other ID",
                                       "Mean number of observations per brighten ID",
                                       "95% confidence interval of mean on brighten ID"),
                      stringsAsFactors = FALSE,
                     check.names = FALSE)
