...
Records Generated in Chapter 1 are used to identify and organize files in the transformation step.

```{r load_file_descriptions}
MatchedRecords <- read.csv("../Reports/Description of Initially Available Data/MatchedRecords.csv")
FileInformation <- read.csv("../Data/LocalFileInformation.csv")
```

# Transformation Before Load

Transformed tables will be stored in a new, flat, directory structure. 

```{r making_local_directory tree}
